...
class FrenchLesson6 extends StatefulWidget {
  const FrenchLesson6({Key? key}) : super(key: key);

  @override
  State<FrenchLesson6> createState() => _FrenchLesson6State();
}

class _FrenchLesson6State extends State<FrenchLesson6> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchFrenchLesson6();
  }
