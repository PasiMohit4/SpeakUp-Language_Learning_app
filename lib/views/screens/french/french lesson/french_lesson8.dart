...
class FrenchLesson8 extends StatefulWidget {
  const FrenchLesson8({Key? key}) : super(key: key);

  @override
  State<FrenchLesson8> createState() => _FrenchLesson8State();
}

class _FrenchLesson8State extends State<FrenchLesson8> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchFrenchLesson8();
  }
