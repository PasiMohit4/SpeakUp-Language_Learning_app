...
class FrenchLesson1 extends StatefulWidget {
  const FrenchLesson1({Key? key}) : super(key: key);

  @override
  State<FrenchLesson1> createState() => _FrenchLesson1State();
}

class _FrenchLesson1State extends State<FrenchLesson1> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchFrenchLesson1();
  }
