...
class FrenchLesson2 extends StatefulWidget {
  const FrenchLesson2({Key? key}) : super(key: key);

  @override
  State<FrenchLesson2> createState() => _FrenchLesson2State();
}

class _FrenchLesson2State extends State<FrenchLesson2> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchFrenchLesson2();
  }
