...
class FrenchLesson3 extends StatefulWidget {
  const FrenchLesson3({Key? key}) : super(key: key);

  @override
  State<FrenchLesson3> createState() => _FrenchLesson3State();
}

class _FrenchLesson3State extends State<FrenchLesson3> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchFrenchLesson3();
  }
