...
class FrenchLesson7 extends StatefulWidget {
  const FrenchLesson7({Key? key}) : super(key: key);

  @override
  State<FrenchLesson7> createState() => _FrenchLesson7State();
}

class _FrenchLesson7State extends State<FrenchLesson7> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchFrenchLesson7();
  }
