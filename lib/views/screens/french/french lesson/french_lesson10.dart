...
class FrenchLesson10 extends StatefulWidget {
  const FrenchLesson10({Key? key}) : super(key: key);

  @override
  State<FrenchLesson10> createState() => _FrenchLesson10State();
}

class _FrenchLesson10State extends State<FrenchLesson10> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchFrenchLesson10();
  }
