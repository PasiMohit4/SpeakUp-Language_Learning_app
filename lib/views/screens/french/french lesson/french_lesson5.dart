...
class FrenchLesson5 extends StatefulWidget {
  const FrenchLesson5({Key? key}) : super(key: key);

  @override
  State<FrenchLesson5> createState() => _FrenchLesson5State();
}

class _FrenchLesson5State extends State<FrenchLesson5> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchFrenchLesson5();
  }
