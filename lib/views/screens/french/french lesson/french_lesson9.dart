...
class FrenchLesson9 extends StatefulWidget {
  const FrenchLesson9({Key? key}) : super(key: key);

  @override
  State<FrenchLesson9> createState() => _FrenchLesson9State();
}

class _FrenchLesson9State extends State<FrenchLesson9> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchFrenchLesson9();
  }
