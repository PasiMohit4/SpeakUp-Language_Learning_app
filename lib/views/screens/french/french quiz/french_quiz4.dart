...
class FrenchQuiz4 extends StatefulWidget {
  const FrenchQuiz4({Key? key}) : super(key: key);

  @override
  State<FrenchQuiz4> createState() => _FrenchQuiz4State();
}

class _FrenchQuiz4State extends State<FrenchQuiz4> {
  var db = DBQuizConnect();

  late Future _questions;

  Future<List<Question>> getData() async {
    return db.fetchFrenchQuiz4();
  }
