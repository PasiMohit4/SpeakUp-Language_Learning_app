...
class FrenchQuiz3 extends StatefulWidget {
  const FrenchQuiz3({Key? key}) : super(key: key);

  @override
  State<FrenchQuiz3> createState() => _FrenchQuiz3State();
}

class _FrenchQuiz3State extends State<FrenchQuiz3> {
  var db = DBQuizConnect();

  late Future _questions;

  Future<List<Question>> getData() async {
    return db.fetchFrenchQuiz3();
  }
