...
class FrenchQuiz1 extends StatefulWidget {
  const FrenchQuiz1({Key? key}) : super(key: key);

  @override
  State<FrenchQuiz1> createState() => _FrenchQuiz1State();
}

class _FrenchQuiz1State extends State<FrenchQuiz1> {
  var db = DBQuizConnect();

  late Future _questions;

  Future<List<Question>> getData() async {
    return db.fetchFrenchQuiz1();
  }
