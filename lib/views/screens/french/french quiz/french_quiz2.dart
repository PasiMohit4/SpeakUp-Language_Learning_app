...
class FrenchQuiz2 extends StatefulWidget {
  const FrenchQuiz2({Key? key}) : super(key: key);

  @override
  State<FrenchQuiz2> createState() => _FrenchQuiz2State();
}

class _FrenchQuiz2State extends State<FrenchQuiz2> {
  var db = DBQuizConnect();

  late Future _questions;

  Future<List<Question>> getData() async {
    return db.fetchFrenchQuiz2();
  }
