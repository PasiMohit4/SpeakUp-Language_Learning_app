...
class JapaneseLesson4 extends StatefulWidget {
  const JapaneseLesson4({Key? key}) : super(key: key);

  @override
  State<JapaneseLesson4> createState() => _JapaneseLesson4State();
}

class _JapaneseLesson4State extends State<JapaneseLesson4> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchJapaneseLesson4();
  }
