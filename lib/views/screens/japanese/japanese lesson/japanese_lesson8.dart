...
class JapaneseLesson8 extends StatefulWidget {
  const JapaneseLesson8({Key? key}) : super(key: key);

  @override
  State<JapaneseLesson8> createState() => _JapaneseLesson8State();
}

class _JapaneseLesson8State extends State<JapaneseLesson8> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchJapaneseLesson8();
  }
