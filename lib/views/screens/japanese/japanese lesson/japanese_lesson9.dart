...
class JapaneseLesson9 extends StatefulWidget {
  const JapaneseLesson9({Key? key}) : super(key: key);

  @override
  State<JapaneseLesson9> createState() => _JapaneseLesson9State();
}

class _JapaneseLesson9State extends State<JapaneseLesson9> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchJapaneseLesson9();
  }
