...
class JapaneseLesson1 extends StatefulWidget {
  const JapaneseLesson1({Key? key}) : super(key: key);

  @override
  State<JapaneseLesson1> createState() => _JapaneseLesson1State();
}

class _JapaneseLesson1State extends State<JapaneseLesson1> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchJapaneseLesson1();
  }
