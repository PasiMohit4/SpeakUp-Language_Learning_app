...
class JapaneseLesson2 extends StatefulWidget {
  const JapaneseLesson2({Key? key}) : super(key: key);

  @override
  State<JapaneseLesson2> createState() => _JapaneseLesson2State();
}

class _JapaneseLesson2State extends State<JapaneseLesson2> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchJapaneseLesson2();
  }
