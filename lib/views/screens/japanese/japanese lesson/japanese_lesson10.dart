...
class JapaneseLesson10 extends StatefulWidget {
  const JapaneseLesson10({Key? key}) : super(key: key);

  @override
  State<JapaneseLesson10> createState() => _JapaneseLesson10State();
}

class _JapaneseLesson10State extends State<JapaneseLesson10> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchJapaneseLesson10();
  }
