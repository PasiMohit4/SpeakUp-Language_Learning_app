...
class JapaneseLesson3 extends StatefulWidget {
  const JapaneseLesson3({Key? key}) : super(key: key);

  @override
  State<JapaneseLesson3> createState() => _JapaneseLesson3State();
}

class _JapaneseLesson3State extends State<JapaneseLesson3> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchJapaneseLesson3();
  }
