...
class JapaneseLesson7 extends StatefulWidget {
  const JapaneseLesson7({Key? key}) : super(key: key);

  @override
  State<JapaneseLesson7> createState() => _JapaneseLesson7State();
}

class _JapaneseLesson7State extends State<JapaneseLesson7> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchJapaneseLesson7();
  }
