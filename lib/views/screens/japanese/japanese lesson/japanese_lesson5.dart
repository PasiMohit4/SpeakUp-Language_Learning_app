...
class JapaneseLesson5 extends StatefulWidget {
  const JapaneseLesson5({Key? key}) : super(key: key);

  @override
  State<JapaneseLesson5> createState() => _JapaneseLesson5State();
}

class _JapaneseLesson5State extends State<JapaneseLesson5> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchJapaneseLesson5();
  }
