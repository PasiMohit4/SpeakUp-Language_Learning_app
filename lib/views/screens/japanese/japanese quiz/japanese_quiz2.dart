...
class JapaneseQuiz2 extends StatefulWidget {
  const JapaneseQuiz2({Key? key}) : super(key: key);

  @override
  State<JapaneseQuiz2> createState() => _JapaneseQuiz2State();
}

class _JapaneseQuiz2State extends State<JapaneseQuiz2> {
  var db = DBQuizConnect();

  late Future _questions;

  Future<List<Question>> getData() async {
    return db.fetchJapaneseQuiz2();
  }
