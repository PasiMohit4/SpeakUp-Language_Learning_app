...
class JapaneseQuiz3 extends StatefulWidget {
  const JapaneseQuiz3({Key? key}) : super(key: key);

  @override
  State<JapaneseQuiz3> createState() => _JapaneseQuiz3State();
}

class _JapaneseQuiz3State extends State<JapaneseQuiz3> {
  var db = DBQuizConnect();

  late Future _questions;

  Future<List<Question>> getData() async {
    return db.fetchJapaneseQuiz3();
  }
