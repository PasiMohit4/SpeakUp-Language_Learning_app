...
class JapaneseQuiz4 extends StatefulWidget {
  const JapaneseQuiz4({Key? key}) : super(key: key);

  @override
  State<JapaneseQuiz4> createState() => _JapaneseQuiz4State();
}

class _JapaneseQuiz4State extends State<JapaneseQuiz4> {
  var db = DBQuizConnect();

  late Future _questions;

  Future<List<Question>> getData() async {
    return db.fetchJapaneseQuiz4();
  }
