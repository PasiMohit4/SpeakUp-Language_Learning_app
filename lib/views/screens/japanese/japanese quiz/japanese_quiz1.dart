...
class JapaneseQuiz1 extends StatefulWidget {
  const JapaneseQuiz1({Key? key}) : super(key: key);

  @override
  State<JapaneseQuiz1> createState() => _JapaneseQuiz1State();
}

class _JapaneseQuiz1State extends State<JapaneseQuiz1> {
  var db = DBQuizConnect();

  late Future _questions;

  Future<List<Question>> getData() async {
    return db.fetchJapaneseQuiz1();
  }
