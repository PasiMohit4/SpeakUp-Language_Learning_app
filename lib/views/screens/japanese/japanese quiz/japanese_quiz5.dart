...
class JapaneseQuiz5 extends StatefulWidget {
  const JapaneseQuiz5({Key? key}) : super(key: key);

  @override
  State<JapaneseQuiz5> createState() => _JapaneseQuiz5State();
}

class _JapaneseQuiz5State extends State<JapaneseQuiz5> {
  var db = DBQuizConnect();

  late Future _questions;

  Future<List<Question>> getData() async {
    return db.fetchJapaneseQuiz5();
  }
