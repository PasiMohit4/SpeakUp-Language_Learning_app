...
class SpanishQuiz5 extends StatefulWidget {
  const SpanishQuiz5({Key? key}) : super(key: key);

  @override
  State<SpanishQuiz5> createState() => _SpanishQuiz5State();
}

class _SpanishQuiz5State extends State<SpanishQuiz5> {
  var db = DBQuizConnect();

  late Future _questions;

  Future<List<Question>> getData() async {
    return db.fetchSpanishQuiz5();
  }
