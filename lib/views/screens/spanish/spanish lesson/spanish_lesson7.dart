...
class SpanishLesson7 extends StatefulWidget {
  const SpanishLesson7({Key? key}) : super(key: key);

  @override
  State<SpanishLesson7> createState() => _SpanishLesson7State();
}

class _SpanishLesson7State extends State<SpanishLesson7> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchSpanishLesson7();
  }
