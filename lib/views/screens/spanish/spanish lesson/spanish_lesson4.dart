...
class SpanishLesson4 extends StatefulWidget {
  const SpanishLesson4({Key? key}) : super(key: key);

  @override
  State<SpanishLesson4> createState() => _SpanishLesson4State();
}

class _SpanishLesson4State extends State<SpanishLesson4> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchSpanishLesson4();
  }
