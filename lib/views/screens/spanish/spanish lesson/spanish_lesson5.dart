...
class SpanishLesson5 extends StatefulWidget {
  const SpanishLesson5({Key? key}) : super(key: key);

  @override
  State<SpanishLesson5> createState() => _SpanishLesson5State();
}

class _SpanishLesson5State extends State<SpanishLesson5> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchSpanishLesson5();
  }
