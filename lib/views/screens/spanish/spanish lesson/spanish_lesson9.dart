...
class SpanishLesson9 extends StatefulWidget {
  const SpanishLesson9({Key? key}) : super(key: key);

  @override
  State<SpanishLesson9> createState() => _SpanishLesson9State();
}

class _SpanishLesson9State extends State<SpanishLesson9> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchSpanishLesson9();
  }
