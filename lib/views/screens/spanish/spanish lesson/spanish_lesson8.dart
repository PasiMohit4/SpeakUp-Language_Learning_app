...
class SpanishLesson8 extends StatefulWidget {
  const SpanishLesson8({Key? key}) : super(key: key);

  @override
  State<SpanishLesson8> createState() => _SpanishLesson8State();
}

class _SpanishLesson8State extends State<SpanishLesson8> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchSpanishLesson8();
  }
