...
class SpanishLesson6 extends StatefulWidget {
  const SpanishLesson6({Key? key}) : super(key: key);

  @override
  State<SpanishLesson6> createState() => _SpanishLesson6State();
}

class _SpanishLesson6State extends State<SpanishLesson6> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchSpanishLesson6();
  }
