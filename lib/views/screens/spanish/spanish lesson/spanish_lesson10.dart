...
class SpanishLesson10 extends StatefulWidget {
  const SpanishLesson10({Key? key}) : super(key: key);

  @override
  State<SpanishLesson10> createState() => _SpanishLesson10State();
}

class _SpanishLesson10State extends State<SpanishLesson10> {
  var db = DbLessonConnect();

  late Future _lesson;

  Future<List<Lesson>> getData() async {
    return db.fetchSpanishLesson10();
  }
